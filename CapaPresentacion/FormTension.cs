...
{
    public partial class FormTension : Form
    {
        private MaterialRepositorio materialRepo;
        private CalculoTension calculoTension;

        public FormTension()
        {
            InitializeComponent();
            materialRepo = new MaterialRepositorio();
            calculoTension = new CalculoTension();
        }

        private void FormTension_Load(object sender, EventArgs e)
        {
            CargarMateriales();
        }
        ...
        private void btnCalcular_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                // Realizar cálculo
                var resultado = calculoTension.CalcularTension(fuerza, area, longitudInicial, moduloYoung);
        ...
        private void MostrarResultados(ResultadoTension resultado, double fuerza,
                                     double area, double longitudInicial, double moduloYoung)
        {
            txtResultados.Clear();
            txtResultados.AppendText("═══════════════════════════════════════════════════════\r\n");
            txtResultados.AppendText("         RESULTADOS DEL CÁLCULO DE TENSIÓN\r\n");
            txtResultados.AppendText("═══════════════════════════════════════════════════════\r\n\r\n");

            txtResultados.AppendText("DATOS DE ENTRADA:\r\n");
            txtResultados.AppendText("───────────────────────────────────────────────────────\r\n");
            txtResultados.AppendText($"Material: {cboMaterial.SelectedItem}\r\n");
            txtResultados.AppendText($"Fuerza aplicada (F⊥): {fuerza:N2} N\r\n");
            ...
            txtResultados.AppendText("───────────────────────────────────────────────────────\r\n");
            txtResultados.AppendText($"Esfuerzo de tensión (σ):\r\n");
            txtResultados.AppendText($"  {resultado.EsfuerzoTension:E3} Pa\r\n");
            txtResultados.AppendText($"  {resultado.EsfuerzoTension / 1e6:N2} MPa\r\n\r\n");

            txtResultados.AppendText($"Deformación por tensión (ε):\r\n");
            txtResultados.AppendText($"  {resultado.DeformacionTension:E6} (adimensional)\r\n");
            txtResultados.AppendText($"  {resultado.DeformacionTension * 100:N6} %\r\n\r\n");

            txtResultados.AppendText($"Alargamiento absoluto (ΔL):\r\n");
            txtResultados.AppendText($"  {resultado.AlargamientoAbsoluto:E6} m\r\n");
            txtResultados.AppendText($"  {resultado.AlargamientoAbsoluto * 1000:N6} mm\r\n\r\n");
